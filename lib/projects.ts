...
export const projects: Project[] = [
  {
    ...
    spec: {
      facts: [
        ...
        { label: "training scale", value: "21,900+ rollout games · 2,410+ PPO updates · 86,297 BC transitions" },
