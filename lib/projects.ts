...
export const projects: Project[] = [
  {
    ...
    spec: {
      facts: [
        ...
        { label: "observation", value: "717-d structured vector · 132-d per-card deck count vector · 19 monster power slots · 66-monster knowledge base" },
        { label: "action space", value: "134 discrete actions (legal-action masked via -∞ logits)" },
        { label: "deck-building", value: "learned (Path 2) — RL-controlled card removal & upgrade; potential-based deck-quality reward" },
        { label: "network", value: "717→512→256→256→{134 logits + 1 value} · GELU · ~571K params · CPU-only" },
        { label: "warm transfer", value: "585→717 and 530→585 obs expansions via zero-initialized new inputs; earlier 256×256 Tanh → 512×256×256 GELU migration" },
        { label: "training scale", value: "24,000+ rollout games · 3,200+ PPO updates · 86,297 BC transitions" },
        ...
        { label: "deployment", value: "local Windows GUI · or headless GCP c3-standard-22 spot VM (22 vCPU, no GPU) — 8 workers under per-worker Xvfb + software GL, ~90+ games/hr · self-healing (cron auto-resume + Cloud Scheduler preemption restart)" },
      ],
      problem: [
            ...
            └────────────────────┘         │  GAE advantages        │
                                           ...
                                           └──────────┬─────────────┘
                                            ...
                                            └─────────┬──────────┘
                                                ...
                                                (workers reload)`,
      observation: {
        title: "observation encoder (717-d)",
        intro:
        ...
        rows: [
          ...
          { dims: "585–716", component: "per-card deck count vector — exact composition over the Ironclad pool (Path 2)", type: "counts" },
        ],
      },
      actions: {
