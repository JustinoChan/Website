...
export const projects: Project[] = [
  {
    ...
    spec: {
      facts: [
        ...
        { label: "deck-building", value: "learned (Path 2) — RL-controlled card removal & upgrade; potential-based deck-quality reward; new deck inputs integrating (first-layer weight-ratio ~0.59 of the original inputs, climbing)" },
